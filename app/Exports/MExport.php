...
{
    function __construct($year = null, $id=null, $data = null)
    {
        $this->id = $id;
        $this->year = $year;
        $this->iterator = 1;
    ...
    {
        $data = DB::table('measurements as m')->select(
            'm.daya_aktif',
            'm.daya_reaktif',
            'm.daya_semu',
            'm.tegangan_satu_fasa',
            'm.tegangan_tiga_fasa',
            'm.tegangan_tidak_seimbang',
            'm.arus',
            'm.frekuensi',
            'm.harmonisa_arus',
            'm.harmonisa_tegangan',
            'm.faktor_daya'
        )
