    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content bgdark shadow-2-strong ">
            ...
            <div class="modal-footer border-0">
                ...
                <form id="user-delete-form" method="POST" action="{{ route('user.destroy', ['user' => $data->user_id]) }}">
                    @csrf
                    @method('DELETE')
...
<div class="modal fade" id="resetModal" tabindex="-1" role="dialog" aria-labelledby="resetExample"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content bgdark shadow-2-strong ">
            ...
            <div class="modal-body border-0 text-dark">Jika anda yakin, Tekan Oke !!</div>
            <div class="modal-footer border-0">
                <button class="btn btn-danger" type="button" data-dismiss="modal">Batal</button>
                <a class="btn btn-primary" href="{{ route('logout') }}"
                ...
                <form id="user-reset-form" method="POST" action="{{ route('user.reset')}}">
                    @csrf
